...
import { Box, Drawer, Avatar, Typography, Divider, List as MuiList, ListItem, ListItemButton, ListItemIcon, ListItemText, Button, IconButton } from '@mui/material';
        ...
        <>
            <Drawer anchor="left" open={drawerOpen} onClose={() => setDrawerOpen(false)}>
                <Box sx={{ width: 280, height: '100%', display: 'flex', flexDirection: 'column' }} role="presentation">
                    <Box sx={{ p: 3, pt: 5, display: 'flex', flexDirection: 'column', alignItems: 'center', bgcolor: '#FAFAFA', position: 'relative' }}>
                        <Box sx={{ position: 'relative' }}>
                            ...
                            <IconButton 
                                ...
                                sx={{ position: 'absolute', bottom: 10, right: -15, bgcolor: 'white', boxShadow: 2, '&:hover': { bgcolor: '#f0f0f0' }, p: 0.5 }}
                            >
                    ...
                    <Divider />
                    <MuiList sx={{ p: 2, flex: 1 }} onClick={() => setDrawerOpen(false)} onKeyDown={() => setDrawerOpen(false)}>
